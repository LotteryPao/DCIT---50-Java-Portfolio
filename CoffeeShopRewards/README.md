...
* This is my system for the BeanBrew Coffee Shop lab activity. The goal was to create a Java program that acts as a rewards system for a cafe. I wrote code to handle customer transactions, track loyalty points for free drinks, and keep a count of all registered customers using Object-Oriented Programming principles.

## Project Structure: The system consists of a single Java file containing two classes
     
1. **Customer** -  The blueprint for customer objects. It handles:
...
2. **CoffeeShop**: The Main class that runs the simulation. It handles:
